...
class PDMP:
    ...
    def jump_times_HMC(self, models, T, N, shape = None, x_init = None, v_init = None, exponent = 2., print_progession = False, get_sample_history = False):
        if print_progession:
            print_progession = lambda x : tqdm(x)
        else:
            print_progession = lambda x : x
...
#
    ...
    def splitting_HMC_DRD(self, models, T, N, shape = None, x_init=None, v_init=None, exponent=2., print_progession = False, get_sample_history = False):
        if print_progession:
            print_progession = lambda x : tqdm(x)
        else:
            print_progession = lambda x : x
    ...
    def splitting_BPS_RDBDR(self, models, T, N, shape = None, x_init=None, v_init=None, exponent=2., print_progession = False, get_sample_history = False):
        if print_progession:
            print_progession = lambda x : tqdm(x)
        else:
            print_progession = lambda x : x
    ...
    def Euler_BPS(self, models, T, N, shape = None, x_init=None, v_init=None, exponent=2., print_progession = False, get_sample_history=False):
        if print_progession:
            print_progession = lambda x : tqdm(x)
        else:
            print_progession = lambda x : x
