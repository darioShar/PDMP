...
from bem.datasets import is_image_dataset
...
def update_parameters_before_loading(p, args):
    ...
    if args.reverse_steps is not None:
        p['eval'][p['method']]['reverse_steps'] = args.reverse_steps
...
def parse_args():
    ...
    parser.add_argument("--method", help='noising process to use', default=None, type=str, choices=['diffusion', 'pdmp', 'nf'])
